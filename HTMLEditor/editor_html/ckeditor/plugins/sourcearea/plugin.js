		...
		init: function( editor ) {
			...
			editor.addMode( 'source', function( callback ) {
				var contentsSpace = editor.ui.space( 'contents' ),
					textarea = contentsSpace.getDocument().createElement( 'div' );
				textarea.addClass( 'cke_source cke_reset cke_enable_context_menu' );
				textarea.setAttribute('id', 'aceEditor');
				textarea.setStyles(
				...
				aceEditor.setTheme(editor.config.sourceAreaTheme || '../../../ace/theme/chrome');
				aceEditor.getSession().setMode('../../../ace/mode/html');
				aceEditor.setValue(editor.getData(1));

				var editable = editor.editable( new sourceEditable( editor, textarea, aceEditor ) );
