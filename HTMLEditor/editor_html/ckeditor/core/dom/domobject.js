...
( function( domObjectProto ) {
	...
	domObjectProto.getCustomData = function( key ) {
		var expandoNumber = null;

		try {
			expandoNumber = this.$[ 'data-cke-expando' ];
		} catch (err) {}
	...
	domObjectProto.getUniqueId = function() {
		var data1 = null;
		var data2 = null;
		try { data1 = this.$['data-cke-expando']; } catch (err) {  }
		try { data2 = CKEDITOR.tools.getNextNumber(); } catch (err) {  }

		if (data1 != null) {
			return data1;
		} else {
			try { this.$['data-cke-expando'] = data2; } catch (err) { }
			return data2;
		}
	};
